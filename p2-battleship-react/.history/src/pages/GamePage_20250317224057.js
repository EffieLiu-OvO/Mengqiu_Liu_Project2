...
import ShipPlacementBoard from "../components/ShipPlacementBoard"; // 新增
...
const GamePage = () => {
  ...
  useEffect(() => {
    ...
    // 如果游戏尚未开始，并且不是放置模式，则根据URL参数启动游戏
  ...
  }, [state.enemyBoard, state.playerBoard, state.gameStatus]); // 当棋盘状态或游戏状态变化时重新绑定事件
